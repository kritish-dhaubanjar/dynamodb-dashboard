        ...
        <div class="card-header py-3 border-0">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <ul>
                <li>
                  <small>AttributeDefinitions – Data types for the key schema attributes.</small>
                </li>
                <li>
                  <small>
