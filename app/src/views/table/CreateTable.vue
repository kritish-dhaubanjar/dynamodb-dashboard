    ...
    <div class="col-12 col-xl-11">
      ...
      <div class="card rounded-0 border-0 shadow-sm">
        <div class="card-header py-3 border-0">
          ...
          <small>
            DynamoDB is a schemaless database that requires only a table name
            and a primary key when you create the table.
          </small>
        </div>
          ...
          <div class="mb-3">
            <div class="row">
              <div class="col-xl-4">
                ...
                />
                <div class="form-text">
                  Between 3 and 255 characters, containing only letters,
            ...
            <label class="form-label"
              >Partition key<br />
              <small class="text-muted">
                The partition key is part of the table's primary key. It is a
                hash value that is used to retrieve items from your table and
                allocate data across hosts for scalability and availability.
              </small>
            </label>
            ...
            <label class="form-label"
              ...
              <br />
              <small class="text-muted">
                You can use a sort key as the second part of a table's primary
                key. The sort key allows you to sort or search among all items
        ...
        <div class="card-body border-0">
          <div class="row mb-4" v-for="(index, i) in table.indices" :key="i">
            <div class="col-lg-3 col-xl-1 mb-2">
              ...
              <select class="rounded-0 form-select" v-model="index.type">
            ...
            <div class="col-lg-3 col-xl-2 mb-2">
              ...
              <select class="rounded-0 form-select" v-model="index.sk.type">
                <option value="S">String</option>
                <option value="N">Number</option>
                <option value="BOOL">Boolean</option>
              </select>
          ...
          <div class="alert alert-info rounded-0 my-4">
            By default, the global secondary index's capacity is the same as
            your base table's capacity.
          </div>
        </div>
      </div>
      ...
      <div class="d-flex justify-content-end">
        ...
        <button class="btn btn-primary rounded-0" type="button" @click="create">
          <span
